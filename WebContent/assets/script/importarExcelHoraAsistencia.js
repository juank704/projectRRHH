...
function UploadFileHoraAsistencia(idInput,ruta) {
	...
	$.ajax({
		url : "/simpleWeb/UploadExcelHoraAsistencia",
		dataType : 'script',
		cache : false,
		async : false,
		contentType : false,
	...
	$("#loading").show();
		...
		$.ajax({
			url : "/simpleWeb/json/work/insertExelmysqlHoraAsistencia/",
			type : "PUT",
			dataType : "text",
			async : false,
...
function excel(){
	...
	var ruta = "/simplework/Nomina/Anticipo/importarExcelHoraExtraFalta.xlsx";
