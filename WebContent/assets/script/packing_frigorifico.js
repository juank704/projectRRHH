...
function GuardarRegistro(){
	if(!$('#campo_taller').val()){
		...
		console.log(datos)
		$.ajax({
				url : "/simpleWeb/json/AGRO/ADD_PackingFrigorifico/",
				type : "PUT",
...
function ValorPredeterminado(){
	$('#fecha_taller').prop("value","");
	$('#BoxDiagnostico').prop("value","");
	$('#BoxEquipo').first().focus();
}
var arrayMaterial = [];
