...
function Enviar(){
    ...
    var tipo_cese = $("#tipoaviso").val();

    
	$("#loading").show();
	$.ajax({
		url : "/simpleWeb/json/work/generateNominaAFC/"+ valueSociedad + "," +fechaISplit + "," + fechaTSplit +","+ tipo_division + ","+ tipo_cese ,
		type : "PUT",
		dataType : "text",
...
//     		var myJSON = data;
			window.open("/simpleWeb/json/work/descargarNominaAFC/?FILE="+myJSON);
			}
			$("#loading").hide();
