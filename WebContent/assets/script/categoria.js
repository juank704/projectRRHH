var dataTable = $('#TableCategoria').DataTable({
...
var tablaEstadoFenologico = $("#DivCategoria").html();
var arrayCategoria;
var datos;

var tabla2 = $("#DivCategoria").html();
//var table = $('#BodyCategoria').DataTable;
...
function loadInfo() {
	...
	$.getJSON("/simpleWeb/json/AGRO/GETMantenedor_SA/CATEGORIA", function(data) {
		arrayCategoria = data;
		loadTabla(data);
	});
	$("#loading").hide();
...
function cargarRegistro() {
	...
	$.ajax({
		url : "/simpleWeb/json/AGRO/ADD_Categoria/",
		type : "PUT",
...
//	LimpiarTabla();
	...
	console.log(codigo);
	$.ajax({
		url : "/simpleWeb/json/AGRO/UPDATE_Categoria/",
		type : "PUT",
...
//	  LimpiarTabla();
	...
	$(c.aceptar).click(function(){
		...
		$.ajax({
			type: "PUT",
			async: false,
			url: "/simpleWeb/json/AGRO/UP_Categoria_Estado/",
