			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button style="display: visible;" id="imprimirMasivoBotonModal"
						...
						onclick="generarDocumentosMasivos(true)">IMPRIMIR
...
<form action="#" id="searchForm"
	...
	<div class="row">
		...
		<div class="col-md-2">
			...
			<select id="idCECO"
				class=" form-control btn-circle btn-sm mayusculasWork" name="idCECO">
		...
		<!-- <div class="col-md-2">
			<h5 class="text-center">Excluir Trabajadores de Nomina</h5>
			<input id="tipoContrato" type="checkbox"
				class=" form-control btn-circle btn-sm mayusculasWork"
				name="_excluirNomina" />
		</div> -->
	</div>
	...
	<div class="row" style="margin-top: 30px; margin-bottom: 30px;">
		...
		<div class="col-md-offset-1 col-md-2">
			<a id="documentacionMasiva"
				...
				<i class="fa fa-floppy-o fa-lg"></i> Calcular
			</a>
		</div>
...
<div class="table-responsive2">
	...
	<table
		...
		<thead>
			<tr>
				<th style='text-align: center; width: 2%;'><input
				...
				<th style='text-align: center; min-width: 100px; width: 100px;'>Periodo</th>
				<th style='text-align: center; min-width: 100px; width: 100px;'>Fecha Pago</th>
