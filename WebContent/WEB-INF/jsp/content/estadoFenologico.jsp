<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<h4>Estado Fenológico</h4>
	<div class="table-responsive" id="DivEstado">
	<table class="table table-bordered table-hover table-striped table-condensed dataTable no-footer" id="EstadoF">
		<thead>
			<tr>
