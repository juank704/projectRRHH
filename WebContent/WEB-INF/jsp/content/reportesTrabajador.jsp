        	...
        	<form class="form-horizontal form-fix noRadius noBorder"  id="crearLibroForm" role="form">
				<div class="form-body">
					...
					<div class="form-actions right1">
						...
						<button type="submit" class="btn green" id="agregarSubmit">Generar Reporte</button>
					</div>
				</div>
			</form>	
      </div>
...
<h4>Filtros</h4>
	<div class="row margin-bottom">
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<select id="selectorSociedad" class=" form-control btn-circle btn-sm mayusculasWork" name="sociedad">
				</select>
			</div>
		</div>
		<div class="col-md-6">
			<div class="col-md-4">
				<h5 class="text-center">Informes</h5>
			</div>
			<div class="col-md-6">
				<select required id="selectorInformes" class=" form-control btn-circle btn-sm mayusculasWork" >
					<option value="">Seleccione...</option>
					<option value="1">Trabajadores Duplicados</option>
				</select>
			</div>
		</div>
	</div>
		<div class="row">
			<div class="col-md-offset-8 col-md-4 text-right">
				<a id="documentacionMasiva"
					...
					<i class="fa fa-file-excel-o fa-lg"></i> Generar Reporte Excel
				</a>
			</div>
		</div>
