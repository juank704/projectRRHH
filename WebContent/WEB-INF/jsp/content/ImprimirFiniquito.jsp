...
<div class="col-md-12 portlet light bordered">
	<div class="row">
		...
		<div class="col-md-4">
			<div class="col-md-12">
				<h4>Fecha Pago Finiquito</h4>
			</div>
			<div class="col-md-12">
				<input type="text" id="fechaPago"  placeholder="Seleccione Fecha Anticipo"class="form-control btn-circle btn-sm mayusculasWork">
			</div>
		</div>
		<div class="col-md-4">
			<div class="col-md-12">
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<div class="col-md-12">
				<select id="selectTipoCuentaFiniquito"
