...
<div class="col-md-12 portlet light bordered"  id='panelform' >
	<div class="col-md-12 ">
		...
		<div class="col-md-7">
						   	<select id="conceptos" class="form-control input-sm input-circle "></select>
		</div>
<!-- 		<div class="col-md-2"> -->
...
<!-- 		</div> -->
	...
	<div class="col-md-2 "> 
	<select autocomplete="off" id="idContrato" class=" form-control btn-circle btn-sm mayusculasWork">
...
<!-- 				onchange="javascript: valDias(this)" placeholder="Seleccione una Fecha"> -->
	...
	<div class="col-md-12 ">
	    ...
	    <div class="col-md-2 ">
	    		<input autocomplete="off" style="display: none;" type="text" id="fechaCuotasTermino" class="form-control input-circle mayusculasWork"
				onchange="javascript: valDias(this)" placeholder="Seleccione una Fecha" >
	    </div>
	...
	<div class="col-md-12 ">
		...
		<div class="col-md-2" style="margin-left: -27px;">
			...
			<div class="col-md-2" style="margin-left: -27px;">
				<span id='' onclick="exportTableToExcel('haberesyDescuentos')">Excel</span>
			</div>
