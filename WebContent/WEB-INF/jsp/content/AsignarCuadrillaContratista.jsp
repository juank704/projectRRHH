...
<div class="col-xs-12 col-sm-12 col-md-12" id="agregar_datos_comunes" style="display: block;">
	<h3 style="text-align: center;">Agregar Datos Base Contratista</h3>
	<div class="portlet">
	...
	<div class="col-xs-12 col-sm-12 col-md-12">
		<div class="col-xs-12 col-sm-12 col-md-12 portlet">
			<div class="col-xs-12 col-sm-4 col-md-4 ">
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<input type="text" name="fecha" id="fecha_rendimiento" onchange="resetSupervisor(this)" class="form-control fecha required" readonly>
			...
			<div class="col-xs-12 col-sm-4 col-md-4 ">
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<select id="campo_rendimiento" class="form-control input-sm required" onchange="javascript: cambioCampo(this.value);"></select>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 portlet" >
			<div class="col-xs-12 col-sm-4 col-md-4 ">
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<input type="text" onkeypress="return justNumbers(event);" id="hora_rendimietno" class="form-control required">
				</div>
			</div>
			<div class="col-xs-12 col-sm-4 col-md-4 ">
				<div class="col-xs-12 col-sm-12 col-md-12">
			...
			<div class="col-xs-12 col-sm-4 col-md-4 ">
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<select id="contratista" class="form-control input-sm required" >
...
<!-- 					<input type="checkbox" checked data-toggle="toggle" data-size="mini" data-onstyle="success"> -->
<!-- 					<input type='checkbox' title='Agregar Base Piso Dia' checked data-toggle="toggle"  data-size="mini" data-onstyle="success" onchange='javascript: basePisoAdd(this);' class='checkbox'/>
				</div>
<!-- 				<label class="switch2"> -->
