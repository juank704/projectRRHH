...
<div class="modal fade" id="crearLibroModal" tabindex="-1" role="dialog" aria-labelledby="crearLibroModal" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <h3 class="modal-title title-padding" id="crearLibroLabel">Subir archivo de Centralización</h3>
		<div class="modal-body padding-top-5">
        	<form class="form-horizontal form-fix noRadius noBorder"  id="crearLibroForm" role="form" enctype="multipart/form-data">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							 <label for="exampleFormControlFile1"></label>
   							 <input type="file" class="file" id="exampleFormControlFile1" required>
							 <!-- <input type="file" class="form-control noRadius file " id="crearNombreCentralizacion" name="crearNombreCentralizacion" placeholder="Nombre Centralizacion" required>  --> 
						</div>
					</div>
				</div>
			</form>	
...
<h4>Filtros</h4>
	<div class="row margin-bottom">
		<div class="col-md-4" >
			...
			<div class="col-md-6">
				<select id="selectorSociedad" class=" form-control btn-circle btn-sm mayusculasWork" name="selectorSociedad" onchange="traerPeriodos(this)">
				</select>
			</div>
		</div>
		<div class="col-md-4" >
			...
			<div class="col-md-6">
				<select id="selectorPeriodo" class=" form-control btn-circle btn-sm mayusculasWork" name="selectorPeriodo" onchange="traerDatos(this)">
				</select>
			</div>
		</div>
		<div class="col-md-4">
		...
		<div class="row">
			<div class="col-md-offset-7 col-md-3 text-right">
				<a id="btnUpload" style="display:none;"
					title="Subir Centralizacion en Excel"
					class="btn btn-circle red btn-outline col-md-11"
					data-toggle="modal" onclick="abrirCerrarModal()">
					<i class="fa fa-file-excel-o fa-lg"></i><span> </span><i class="fa fa-upload fa-lg"></i> Subir Centralizacion Excel
				</a>
			</div>
			<div class=" col-md-2 text-right">
				<a id="documentacionMasiva" 
					...
					data-toggle="modal" onclick="Centralizar()">
					<i class="fa fa-cogs fa-lg"></i> Centralizar
				</a>
			</div>
		</div>
