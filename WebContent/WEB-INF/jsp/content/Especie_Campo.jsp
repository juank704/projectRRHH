...
<div class="table-responsive" id="Div_Especie_Campo">
	<table class="table table-bordered table-hover table-striped table-condensed dataTable no-footer" id="Table_Especie_Campo">
		<thead>
			<tr>
				<th style="width: 15%; min-width: 150px;">Especie</th>
