        ...
        <h4>Filtros</h4>
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <input type="text" id="periodoRemuneracionesB" class=" form-control btn-circle btn-sm">
            ...
            <div class="col-md-4 text-center">
                ...
                <div class="col-md-12 ">
                     <input type="date" id="fechaPagoB" class=" form-control btn-circle btn-sm">
                </div>
            </div>
			<div class="col-md-4 text-center"">
				<h5 class="text-center">Monto</h5>
				<div class="col-md-12 ">
					<input id="montoTrabajador" type="text" name="ReAct"
						class="form-control input-circle number"
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="col-xs-12 col-sm-2 col-md-2  col-sm-offset-1 col-md-offset-1 text-center">
                <h5 class="text-center">Empresa</h5>
                	<select id="SociedadB" class=" form-control btn-circle btn-sm" >
				<option value="">Seleccione una Empresa</option>
				</select>
            </div>
             <div class="col-xs-12 col-sm-2 col-md-2 text-center">
                <h5 class="text-center">División</h5>
                      	<select id="tipodivisionB" class=" form-control btn-circle btn-sm" >
				<option value="">Seleccione División</option>
				</select>
            </div>
            <div class="col-xs-12 col-sm-2 col-md-2 text-center">
                <h5 class="text-center">Subdivision</h5>
                     	<select id="tiposubdivisionB" class=" form-control btn-circle btn-sm" >
				<option value="">Seleccione Sub División</option>
				</select>
            </div> 
             <div class="col-xs-12 col-sm-2 col-md-2 text-center">
                <h5 class="text-center">Grupo</h5>
			<select id="listagrupoB" class=" form-control btn-circle btn-sm">
				<option value="">Seleccione Grupo</option>
			</select>
		</div>  
             <div class="col-xs-12 col-sm-2 col-md-2 text-center">
                <h5 class="text-center">Subgrupo</h5>
               	<select id="listasubgrupoB" class=" form-control btn-circle btn-sm" >
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                     ...
                     <div class="input-icon right">
                    	...
                    	<select id="nombreTrabajadorB" class="form-control input-sm input-circle ">
...
<p style="text-align: center;">Resultado Busqueda</p>
	<table class="table table-bordered table-hover tzable-striped table-condensed dataTable no-footer" id="tbl_Info">
					...
					<div id="swal2-content" style="display: block;">
						<div class="col-xs-12 col-sm-12 col-md-12"
							...
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									<input type="text" class="form-control" id="cod_trabUpdate"
										value="" disabled="">
								</div>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									<input type="text" class="form-control" id="nombre_trabUpdate"
										value="" disabled="">
								</div>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									<input type="text" id="periodoRemuneracionesUpdate" class="btn blue btn-outline btn-circle btn-sm">
								</div>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6">
								<div class="col-xs-12 col-sm-12 col-md-12">
							...
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									<select id="SociedadUpdate"
										class=" form-control btn-circle btn-sm" disabled>
										<option value="">Seleccione una Empresa</option>
									</select>
								</div>
							</div>
							...
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									<select id="listagrupoUpdate" class=" form-control btn-circle btn-sm" disabled>
										<option value="">Seleccione Grupo</option>
									</select>
							...
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									...
									<input id="montoTrabajadorUpdate" type="text" name="ReAct" class="form-control input-circle number" placeholder="Monto a Pagar">
								</div>
							</div>
