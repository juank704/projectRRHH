...
<div class="modal fade" id="editarFeriadoModal" tabindex="-1" role="dialog" aria-labelledby="editarFeriadoLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content noRadius">
    
		<div class="modal-body">
        	<form class="form-horizontal form-fix noRadius noBorder" id="editFeriadoForm" role="form" action="#">
				<div class="form-body">
							<input type="text" class="form-control noRadius hide" id="editarIdFeriado" name="editarIdFeriado" placeholder="id"> 
					
					<div class="form-group">
						<label class="col-md-3 control-label">Nombre Feriado</label>
						<div class="col-md-9">
							<input type="text" class="form-control noRadius" id="editarNombreFeriado" name="editarNombreFeriado" placeholder="Nombre Feriado"> 
						</div>
					</div>	
                   	...
                   	<div class="form-group">
						...
						<div class="col-md-9">
							<input type="date" class="form-control noRadius" id="editarFechaFeriado" name="editarFechaFeriado" placeholder="Fecha de Feriado"> 
						</div>
					</div>	
					<div class="form-group hide">
						<label class="col-md-3 control-label">Descripción Feriado</label>
						<div class="col-md-9">
							<input type="text" class="form-control noRadius" id="editarDescripcionFeriado" name="editarDescripcionFeriado" placeholder="Descripción Feriado"> 
						</div>
					</div>	
					<div class="form-group">
					...
					<div class="form-actions right1">
						...
						<button type="submit" class="btn green" id="submitEditFeriado">Editar Feriado</button>
					</div>
				</div>
			</form>	
      </div>
