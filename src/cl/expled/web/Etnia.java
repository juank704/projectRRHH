...
public class Etnia {
	//Instanciamos clase que se conecta a BD
			...
			EtniaDB Et = new EtniaDB();
			
			@RequestMapping("/Etnia")
			public ModelAndView EtniaModulo(Model model,HttpSession httpSession) {
				...
				model.addAttribute("paginaActual", "Etnias");
				model.addAttribute("content", "Etnia");
				model.addAttribute("javaScriptPage","Etnia");
				LOG.info("Se termina de configurar modulo.");
				return new ModelAndView("layout/_main");
			}
			
			@RequestMapping("/content/Etnia")
			public ModelAndView EtniaContent(Model model,HttpSession httpSession) {
				...
				return new ModelAndView("content/Etnia");
			}
}
