...
@Controller
public class CajaCompensaciones {
	...
	@RequestMapping("/CajaCompensacion")
	public ModelAndView CajaCompensacionModulo(Model model,HttpSession httpSession) {
		...
		model.addAttribute("paginaActual", "Caja de Compensacion");
		model.addAttribute("content", "CajaCompensacion");
		model.addAttribute("javaScriptPage","CajaCompensacion");
		LOG.info("Se termina de configurar modulo.");
		return new ModelAndView("layout/_main");
	}
	
	@RequestMapping("/content/CajaCompensacion")
	public ModelAndView CajaCompensacionContent(Model model,HttpSession httpSession) {
		...
		return new ModelAndView("content/CajaCompensacion");
	}
