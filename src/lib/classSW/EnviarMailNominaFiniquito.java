...
public class EnviarMailNominaFiniquito {
	@SuppressWarnings("unused")
	private int numero;
//public static void main(String[] args) {
//	@Test
	public  void EnviarMailFiniquitos(int numero,String rutaArchivo,String NombreArchivo) throws Exception{
...
//			impexp_trabajador.updateNOmbreArchivoSW_nomina(ruta,numero);
			...
			NominaAnticipos co = sw_NominaAnticiposDB.getTOCorreoFiniquito();
		  	String CorreoTO = co.getCorreo_to_nomina_finiquito();
			
			message.addRecipient(Message.RecipientType.TO, new InternetAddress(CorreoTO));
			message.setSubject("Solicitud Confirmación Nómina Pago Finiquitos");
