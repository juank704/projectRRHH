...
public class EnviarMailNominaLiquidacion {
	@SuppressWarnings("unused")
	private int numero;
//public static void main(String[] args) {
//	@Test
	public  void EnviarMailLiquidaciones(int numero,String rutaArchivo,String NombreArchivo) throws Exception{
...
//			impexp_trabajador.updateNOmbreArchivoSW_nomina(ruta,numero);
		   ...
		   message.setFrom(new InternetAddress(username));
			...
			NominaAnticipos co = sw_NominaAnticiposDB.getTOCorreoLiquidacion();
		  	String CorreoTO = co.getCorreo_to_nomina_liquidacion();
			
			message.addRecipient(Message.RecipientType.TO,new InternetAddress(CorreoTO));
			message.setSubject("Solicitud Confirmación Nómina Pago Sueldos");
